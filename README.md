...
git pull; rm -rf ../nour.log ../out.log; python watchdog.py -a "-i localhost -p 11999 -n testsber --stdout ../nour.log -l 20 -r -x -b firefox -e" -w 300 -m nourisher/main.py -l ../out.log 
```
